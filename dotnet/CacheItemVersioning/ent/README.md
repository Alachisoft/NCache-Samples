...
- If NuGet packages are not restored properly:
	...
	- **nuget.exe**: Run `nuget restore CacheItemVersioning.sln`.
...
For more information about Optimistic Locking, see:\
