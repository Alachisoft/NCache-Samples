<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="ViewState._Default" EnableViewState="true"%>
...
<body>
    <form id="ProductDetailForm" method="post" runat="server">
        ...
        <asp:GridView ID="grdCustomers" AutoGenerateColumns="false" runat="server"
            ...
            OnRowCommand="grdCustomers_RowCommand"
        ...
        <!-- Grid showing orders for the selected customer -->
        ...
        <!-- Grid showing order details for the selected order -->
