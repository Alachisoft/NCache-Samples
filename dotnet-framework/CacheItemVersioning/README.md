...
cd "<path-to-sample>"
nuget restore CacheItemVersioning.sln
msbuild CacheItemVersioning.sln /p:Configuration=Debug
CacheItemVersioning\bin\Debug\CacheItemVersioning.exe
```
...
- If NuGet packages are not restored properly:
	...
	- Command line: run `nuget restore CacheItemVersioning.sln` in the sample folder (see Build and Run section).
