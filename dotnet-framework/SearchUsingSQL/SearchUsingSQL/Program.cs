...
// LIMITING TO THE IMPLIED WARRANTIES OF MERCHANTABILITY AND
...
namespace SearchUsingSQL
{
    public class Program
    {
        ...
        private static void QueryByNamedTags(bool warranty)
        {
            ...
            using (ICacheReader reader = _cache.SearchService.ExecuteReader(queryCommand))
            {
                int count = 0;
        ...
        private static void QueryByPriceIndex(decimal unitPrice)
        {
        ...
        /// </summary>
        /// <param name="unitPrice">Unit price value to filter products</param>
        private static void QuerySelectedFields(decimal unitPrice)
        {
