...
Before building this sample, if you need to change the cache name and event key, open `Web.config` from the project root directory and change the `CacheName` and `EventKey` values:
