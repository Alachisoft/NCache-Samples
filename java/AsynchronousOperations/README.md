...
This sample uses the SampleData Maven project as a reference for model class `Customer`.
...
To run the sample application, open a command prompt and navigate to the sample project root where the `pom.xml` file is located. Then execute the following commands:
